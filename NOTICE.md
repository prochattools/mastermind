# Mastermind Local Notice

Copyright (C) 2026 ProChat.

The generated public snapshot is licensed under the GNU Affero General Public License version 3 only (`AGPL-3.0-only`). See `LICENSE`.

This software is provided without warranty to the extent permitted by applicable law.

ProChat and associated branding are governed by `TRADEMARKS.md`.
