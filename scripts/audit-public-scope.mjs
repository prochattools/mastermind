...
const ALLOWED_FILES = new Set([
  ...
  path.normalize('docs/product/chatgpt-first-workflow.md'),
  path.normalize('docs/installation.md'),
  path.normalize('docs/architecture.md'),
  path.normalize('docs/safety.md'),
  path.normalize('docs/troubleshooting.md'),
